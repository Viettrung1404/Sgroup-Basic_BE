    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _usersModel["default"].getAllUsers();
        case 3:
          return _context.abrupt("return", _context.sent);
        case 6:
          _context.prev = 6;
          _context.t0 = _context["catch"](0);
          console.error('Error getting all users:', _context.t0);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _usersModel["default"].getUserById(id);
        case 3:
          return _context2.abrupt("return", _context2.sent);
        case 6:
          _context2.prev = 6;
          _context2.t0 = _context2["catch"](0);
          console.error("Error getting user ".concat(id, ":"), _context2.t0);
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _usersModel["default"].updateUser(id, updateData);
        case 3:
        ...
        case 9:
          ...
          console.error("Error updating user ".concat(id, ":"), _context4.t0);
          throw new Error(_context4.t0.message || 'Failed to update user');
        case 13:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _context5.next = 3;
          return _usersModel["default"].deleteUser(id);
        case 3:
        ...
        case 9:
          ...
          console.error("Error deleting user ".concat(id, ":"), _context5.t0);
          throw new Error(_context5.t0.message || 'Failed to delete user');
        case 13:
        case "end":
