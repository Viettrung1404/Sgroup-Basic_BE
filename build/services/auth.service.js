...
exports.resetPassword = exports.registerUser = exports.loginUser = exports.forgotPassword = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _usersModel["default"].getUserByEmail(userData.email);
        case 3:
          user = _context.sent;
        ...
        case 7:
          _context.next = 9;
          return _usersModel["default"].createUser(userData);
        case 9:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          _context2.next = 11;
          return _hashProvider["default"].compareHash(userData.password, user.password);
        case 11:
          _context2.t1 = _context2.sent;
          _context2.t0.log.call(_context2.t0, 'Pass is correct: ', _context2.t1);
        ...
        case 24:
          ...
          console.error('Error log in user:', _context2.t2);
          throw _context2.t2;
        case 28:
        case "end":
...
var forgotPassword = exports.forgotPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(email) {
    var user, token, emailOptions;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _usersModel["default"].getUserByEmail(email);
        case 3:
          user = _context3.sent;
          if (user) {
            _context3.next = 6;
        ...
        case 8:
          ...
          emailOptions = {
            ...
            text: "The token to reset your password: ".concat(token)
          };
          _context3.next = 12;
          return (0, _emailProvider["default"])(emailOptions);
        case 12:
          _context3.next = 14;
          return _usersModel["default"].updateUser(user._id, {
...
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(email, password, token) {
    var user, emailOptions;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 10:
          _context4.next = 12;
          return _usersModel["default"].resetPassword(user._id, {
            password: password,
            resetPasswordToken: null,
            resetPasswordExpires: null,
            lastTimePasswordChange: Date.now()
          });
        case 12:
