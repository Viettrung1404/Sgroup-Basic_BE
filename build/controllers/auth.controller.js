...
exports.resetPassword = exports.registerUser = exports.loginUser = exports.getMe = exports.forgotPassword = void 0;
var AuthService = _interopRequireWildcard(require("../services/auth.service.js"));
var UserService = _interopRequireWildcard(require("../services/users.service.js"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return AuthService.registerUser(req.body);
        case 3:
  ...
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          _req$body = req.body, email = _req$body.email, password = _req$body.password, token = _req$body.token;
          _context5.next = 4;
        ...
        case 7:
          ...
          if (!(_context5.t0.message === 'User not found')) {
            _context5.next = 11;
            break;
          }
        ...
        case 11:
          if (!(_context5.t0.message === 'Invalid token')) {
            _context5.next = 13;
            break;
          }
